...
const Profile = () => {
  const { isDark, ProfileData, isMediumScreen, isSmallScreen } =
    useContext(MyContext);
  const detailts = [
    { heading: "Full Name:", value: ProfileData.name },
    { heading: "Father's Name:", value: ProfileData.fatherName },
    { heading: "Address:", value: ProfileData.address },
    { heading: "Zip Code:", value: ProfileData.zipCode },
    { heading: "Website", value: ProfileData.url },
  ];
      ...
      <Stack direction={isMediumScreen ? "column" : "row"} spacing={2}>
        <CustomCard sx={{ minWidth: "50%", pb: "18.5px", height: "53%" }}>
          <Stack spacing={2.2}>
            ...
            <CustomDivider />
            {[
              { icon: <MailIcon />, value: ProfileData.email },
              {
                icon: <StayCurrentPortraitIcon />,
                value: ProfileData.contactWithCode,
              },
              { icon: <LocationOnIcon />, value: ProfileData.location },
            ].map(({ icon, value }, idx) => (
                ...
                <React.Fragment key={idx}>
                  ...
                  >
                    ...
                    {value ? (
                      ...
                      <CustomSkeleton width={isSmallScreen ? "100%" : "65%"} />
                    )}
                  </Stack>
                  {<CustomDivider />}
                </React.Fragment>
